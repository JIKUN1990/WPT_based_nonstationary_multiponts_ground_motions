function [th dt] = fn_get1Sim_conditional(Mw,Rrup,Vs30,totalEnergytarget,rs,iflg,filereg,Rhyp)
...
%     [prmcoef0]=fn_getPARAM8(Mw,Rrup,Rhyp,Vs30,filereg);
    [prmcoef0]=fn_getPARAM8_conditional(Mw,Rrup,Rhyp,Vs30,totalEnergytarget,filereg);
